...
use crate::{
    ...
    config::Config,
    daemon::VERSION,
    dbus::{DbusRequest, SnapshotPayload, SnapshotVm},
    ...
    async fn handle_get_snapshot(&self) -> String {
        ...
        for id in ids {
            ...
            payload.vms.push(SnapshotVm {
                ...
                read_iops: s.rates.read_iops,
                write_iops: s.rates.write_iops,
                other_iops: s.rates.other_iops,
                read_bw_bps: s.rates.read_bytes_per_second,
                write_bw_bps: s.rates.write_bytes_per_second,
